...
const HomePage = ({ navigation }: RouterProps) => {
  ...
  return (
    <ScrollView contentContainerStyle={styles.scrollContainer}>
      {/* Image at the top */}
      <Image
        source={require('./images/illustrationfeature.png')} // Replace with your local image path
        style={styles.image} 
        resizeMode='contain'
      />
      ...
      <TouchableOpacity onPress={() => navigation.navigate('Instructions')} style={styles.btn}>
        <Text style={styles.btnText}>Preeclampsia Education</Text>
      </TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  text: {
    fontSize: Platform.OS === 'web' ? 60 : 40, // Larger text for web
    textAlign: 'center',
    color: 'black',
    marginBottom: Platform.OS === 'web' ? 100 : 50, // Adjust margins for web
    marginHorizontal: 5,
  },
});
